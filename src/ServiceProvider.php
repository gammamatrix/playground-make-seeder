...
namespace Playground\Make\Seeder;
...
class ServiceProvider extends AuthServiceProvider
{
    ...
    public string $package = 'playground-make-seeder';
    ...
    public function register(): void
    {
        $this->mergeConfigFrom(
            dirname(__DIR__).'/config/playground-make-seeder.php',
    ...
    public function about(): void
    {
        ...
        AboutCommand::add('Playground: Make Seeder', fn () => [
