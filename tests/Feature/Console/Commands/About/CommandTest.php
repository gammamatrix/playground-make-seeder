...
namespace Tests\Feature\Playground\Make\Seeder\Console\Commands\About;

use PHPUnit\Framework\Attributes\CoversClass;
use Playground\Test\OrchestraTestCase;

/**
 * \Tests\Feature\Playground\Make\Seeder\Console\Commands\About
 */
#[CoversClass(\Playground\Make\Seeder\ServiceProvider::class)]
class CommandTest extends OrchestraTestCase
{
    ...
    public function test_command_about_displays_package_information_and_succeed_with_code_0(): void
    {
        ...
        $result->expectsOutputToContain('Playground: Make Seeder');
    }
}
